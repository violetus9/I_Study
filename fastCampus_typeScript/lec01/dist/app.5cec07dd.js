...
"use strict"; // 화면처리 > 라우터 (중계기) : 상황별 화면을 중계하는 역할
...
exports.CONTENT_URL = exports.NEWS_URL = void 0; // 변경의 여지가 있는 것은 변수로 빼두는 것이 좋다 (data)
          ...
          switch (_d.label) {
            ...
            case 2:
              for (i = (this.store.currentPage - 1) * 10; i < this.store.currentPage * 10; i++) {
                _c = this.store.getFeed(i), id = _c.id, title = _c.title, comments_count = _c.comments_count, user = _c.user, points = _c.points, time_ago = _c.time_ago, read = _c.read; // 아이러니하게도 DOM 사용에 대한 직관성 결여의 해결은 DOM 사용을 자제하는것. (문자열을 이용하자!)
...
var store_1 = require("./store"); // 중복이 되는 요소는 유지보수에 유용하지 못하다, 묶어주자
...
},{"./core/router":"src/core/router.ts","./page":"src/page/index.ts","./store":"src/store.ts"}],"../../../../Users/all98/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9318" + '/');
...
},{}]},{},["../../../../Users/all98/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
